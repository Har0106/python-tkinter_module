...
Button(root, text='Download', font='Arial 12', command=download).grid(row=3, column=0, pady=5, padx=5, sticky='e')
Button(root, text='Download Next', font='Arial 12', command=download_next).grid(row=3, column=1, pady=5, padx=5, sticky='w')
label = Label(root, text='', font='Arial 14')
label.grid(row=4, column=0, pady=(5,10), columnspan=2)
